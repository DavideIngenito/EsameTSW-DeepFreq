...
<head>
  ...
  <title>DeepFreq | Nuovi Arrivi</title>
...
<div class="catalog-header">
  <h1 class="catalog-title">Nuovi Arrivi</h1>
</div>

<main class="catalog-page">

  <!-- BARRA LATERALE FILTRI UNITI -->
  <aside class="sidebar">
    <form action="${pageContext.request.contextPath}/nuovi-arrivi" method="GET">
      ...
      <a href="${pageContext.request.contextPath}/nuovi-arrivi" style="display: block; text-align: center; margin-top: 10px; color: #666; font-size: 0.85em; text-decoration: underline;">Resetta Filtri</a>
    </form>
  </aside>
  ...
  <section class="main-content">
    ...
    <c:if test="${empty prodotti}">
      <p style="text-align: center; margin-top: 50px;">Nessun prodotto trovato con i filtri selezionati.</p>
    </c:if>
  </section>
</main>
