...
<head>
  ...
  <title>DeepFreq | Audio Gear</title>
...
<div class="catalog-header">
  <h1 class="catalog-title">Audio Gear & Strumentazione</h1>
</div>
...
<main class="catalog-page">
  ...
  <aside class="sidebar">
    <form action="${pageContext.request.contextPath}/audiogear" method="GET">
      ...
      <div class="filter-group">
        ...
        <label class="filter-item"><input type="checkbox" name="tipo" value="Giradischi" ${tipiSelezionati.contains('Giradischi') ? 'checked' : ''}> Giradischi</label>
        <label class="filter-item"><input type="checkbox" name="tipo" value="In-Ear Monitors" ${tipiSelezionati.contains('In-Ear Monitors') ? 'checked' : ''}> In-Ear Monitors</label>
        <label class="filter-item"><input type="checkbox" name="tipo" value="Cuffie Over-Ear" ${tipiSelezionati.contains('Cuffie Over-Ear') ? 'checked' : ''}> Cuffie Over-Ear</label>
      </div>
      ...
      <a href="${pageContext.request.contextPath}/audiogear" style="display: block; text-align: center; margin-top: 10px; color: #666; font-size: 0.85em; text-decoration: underline;">Resetta Filtri</a>
    </form>
  </aside>
  ...
  <section class="main-content">
    ...
    <c:if test="${empty prodotti}">
      <p style="text-align: center; margin-top: 50px;">Nessun prodotto trovato in questa categoria.</p>
    </c:if>
  </section>
</main>
