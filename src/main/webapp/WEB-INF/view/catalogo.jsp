...
<head>
    ...
    <title>DeepFreq | Catalogo Dischi</title>
...
<div class="catalog-header">
    <h1 class="catalog-title">Tutti i Dischi</h1>
</div>
...
<main class="catalog-page">
    ...
    <aside class="sidebar">
        ...
        <form action="${pageContext.request.contextPath}/catalogo" method="GET">
            ...
            <a href="${pageContext.request.contextPath}/catalogo" style="display: block; text-align: center; margin-top: 10px; color: #666; font-size: 0.85em; text-decoration: underline;">Resetta Filtri</a>
        </form>
    </aside>
    ...
    <section class="main-content">
        ...
        <c:if test="${empty prodotti}">
            <p style="text-align: center; margin-top: 50px;">Nessun prodotto corrisponde ai filtri selezionati.</p>
        </c:if>
    </section>
</main>
